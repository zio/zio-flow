    ...
    (value: A) =>
      schema match {
        ...
        case e: Schema.Enum1[_, _] =>
          addValuePrefix()
          addCase(e.case1, value)
        case e: Schema.Enum2[_, _, _] =>
          addValuePrefix()
          addCase(e.case1, value)
          addCase(e.case2, value)
        case e: Schema.Enum3[_, _, _, _] =>
          addValuePrefix()
          addCase(e.case1, value)
          addCase(e.case2, value)
          addCase(e.case3, value)
        case e: Schema.Enum4[_, _, _, _, _] =>
          addValuePrefix()
          addCase(e.case1, value)
          addCase(e.case2, value)
          addCase(e.case3, value)
          addCase(e.case4, value)
        ...
        case e: Schema.Enum22[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _] =>
          ...
          addCase(e.case20, value)
          addCase(e.case21, value)
          addCase(e.case22, value)
        case e: Schema.EnumN[_, _] =>
          addValuePrefix()
          addCaseSet(e.caseSet.toSeq, value)
