...
import zio.flow.NumericSpec.root
...
object NumericSpec extends DefaultRunnableSpec {
  ...
  val suite1 = suite("NumericIntSpec")(
    addition(1, 2, 1 + 2),
    subtraction(1, 2, -1),
  ...
  val suite2 = suite("NumericLongSpec")(
  ...
  val suite3 = suite("NumericShortSpec")(
  ...
  val suite4 = suite("NumericFloatSpec")(
  ...
  val suite5 = suite("NumericDoubleSpec")(
  ...
  val suite6 = suite("NumericBigIntSpec")(
    ...
    log(BigInt("11111111111"), BigInt("22222222222"), BigInt((Math.log(BigInt("11111111111").doubleValue) / Math.log(BigInt("22222222222").doubleValue)).toInt)),
    root(BigInt("111111111111111"), BigInt("222222222222222"), BigInt("1"))
  )

  val suite7 = suite("NumericBigDecimalSpec")(
    addition(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal("111111.111111") + BigDecimal("222222.222222")),
    subtraction(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal("111111.111111") - BigDecimal("222222.222222")),
    multiplication(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal("111111.111111") * BigDecimal("222222.222222")),
    division(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal("111111.111111") / BigDecimal("222222.222222")),
    log(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal(Math.log(BigDecimal("111111.111111").doubleValue) / Math.log(BigDecimal("222222.222222").doubleValue))),
    root(BigDecimal("11111.1111111111"), BigDecimal("22222.2222222222"), BigDecimal("1.0004192944192845"))
  )
//  val suite1 = suite("NumericAdditionSpec")(addition(1, 2, 1 + 2),
//    addition(1L, 2L, 1L + 2L),
//    addition(1.toShort, 2.toShort, 1.toShort + 2.toShort),
//    addition(1.555f, 2.333f, 1.555f + 2.333f),
//    addition(1.332435, 2.232123, 1.332435 + 2.232123),
...
//    addition(BigDecimal("111111.111111"), BigDecimal("222222.222222"), BigDecimal("111111.111111") + BigDecimal("222222.222222")))
//
//  val suite2 = suite("NumericSubtractionSpec")(
//    subtraction(1, 2, -1),
//    subtraction(1L, 2L, -1L),
//    subtraction(1.toShort, 2.toShort, 1.toShort - 2.toShort),
//    subtraction(1.555f, 2.333f, 1.555f - 2.333f),
...
//  )
//
//  val suite3 = suite("NumericMultiplicationSpec")(
//    multiplication(1, 2, 2),
//    multiplication(1L, 2L, 2L),
//    multiplication(1.toShort, 2.toShort, 1.toShort * 2.toShort),
//    multiplication(1.555f, 2.333f, 1.555f * 2.333f),
...
//  )
//
//  val suite4 = suite("NumericDivisionSpec")(
//    division(1, 2, 0),
//    division(1L, 2L, 0L),
//    division(1.toShort, 2.toShort, 1.toShort / 2.toShort),
//    division(1.555f, 2.333f, 1.555f / 2.333f),
...
//  )
//
//  val suite5 = suite("NumericLogSpec")(
//    log(1, 2, Math.log(1) / Math.log(2)),
//    log(1L, 2L, Math.log(1L) / Math.log(2L)),
//    log(1.toShort, 2.toShort, Math.log(1.toShort) / Math.log(2.toShort)),
//    log(1.555f, 2.333f, Math.log(1.555f) / Math.log(2.333f)),
...
//  )
//
//  val suite6 = suite("NumericRootSpec")(
//    root(1L, 2L, 1L),
//    root(1.toShort, 2.toShort, 1.toShort),
//    root(1.555f, 2.333f, 1.2083198f),
//    root(1.555657, 2.333665, 1.2084734191706394),
